...
esp_err_t esp_blufi_host_init(void)
{
    ...
    rc = ble_svc_gap_device_name_set(CONFIG_MQTT_CLIENT_IDENTIFIER);
    // /home/matellio_dattatray/esp/esp-idf/components/bt/common/btc/profile/esp/blufi/include/esp_blufi.h
    assert(rc == 0);
